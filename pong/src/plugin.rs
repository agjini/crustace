...
use crate::plugin::puck::{add_puck, reset_puck};
use crate::plugin::score::{
    check_goal, display_score, goal_state_on_goal, increment_score_on_goal, shake_on_goal,
...
impl Plugin for PongPlugin {
    fn build(&self, app: &mut App) {
        app.init_state::<AppState>()
            ...
            .add_systems(Startup, (add_playground, add_paddle, add_puck))
            ...
            .add_systems(Update, goal_state_on_goal)
            .add_systems(Update, move_paddle)
            .add_systems(Update, update_score)
            .add_systems(OnEnter(AppState::Goal), (to_kickoff, reset_puck));
    }
}
